...
bool_t
xdr_kademlia_id_t (XDR *xdrs, kademlia_id_t *objp)
{
...
bool_t
xdr_kademlia_ping_t (XDR *xdrs, kademlia_ping_t *objp)
{
	register int32_t *buf;
...
bool_t
xdr_kademlia_data (XDR *xdrs, kademlia_data *objp)
{
	register int32_t *buf;
...
bool_t
xdr_kademlia_store_t (XDR *xdrs, kademlia_store_t *objp)
{
	register int32_t *buf;
...
bool_t
xdr_kademlia_internal_host (XDR *xdrs, kademlia_internal_host *objp)
{
	register int32_t *buf;
...
bool_t
xdr_kademlia_internal_id (XDR *xdrs, kademlia_internal_id *objp)
{
	register int32_t *buf;
...
bool_t
xdr_kademlia_internal_protos (XDR *xdrs, kademlia_internal_protos *objp)
{
	register int32_t *buf;

	 if (!xdr_array (xdrs, (char **)&objp->protos.protos_val, (u_int *) &objp->protos.protos_len, ~0,
...
bool_t
xdr_kademlia_find_node_t (XDR *xdrs, kademlia_find_node_t *objp)
{
	register int32_t *buf;
...
bool_t
xdr_kademlia_find_value_t (XDR *xdrs, kademlia_find_value_t *objp)
{
	register int32_t *buf;
